...
First of all, I create a column called 'month_ending_date', which I want have a data format and contains simply the month....
...
```{r}
# load in data (specialty - also avail: age/sex, deprivation)
...
all_hbs_stays <- inpatients_specialty %>% 
  group_by(quarter) %>% 
